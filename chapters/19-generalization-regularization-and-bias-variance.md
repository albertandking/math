...
<div class="ml-loop">
  <div class="ml-loop-head">
    ...
    <p><span class="figure-inline-label figure-inline-label-order">读图顺序</span>先看训练误差通常怎样单调下降，再看验证误差为何常常呈现先降后升的趋势。</p>
  </div>
...
<span class="figure-inline-label figure-inline-label-takeaway">读后应会</span>最值得立刻自问的一句是：**如果训练误差还在下降，但验证误差已经开始抬头，我究竟应该高兴还是警惕？** 如果你的第一反应开始不再只是“训练得更好了”，而会自动多出一句“也许该停一停、该约束一下，或者该换一个复杂度区间了”，那么泛化视角就算真正进入了你的判断系统。
